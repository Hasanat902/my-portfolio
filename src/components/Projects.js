            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 g-5'>
                <div class="card card-compact w-96 bg-base-100 shadow-xl border">
                    ...
                    <div class="card-body">
                        ...
                        <Link to='/manufacturer' class="btn btn-primary btn-sm">Details</Link>
                        </div>
                    </div>
                </div>
                <div class="card card-compact w-96 bg-base-100 shadow-xl border">
                    ...
                    <div class="card-body">
                        <h2 class="card-title font-bold">Car Warehouse Management</h2>
                        ...
                        <div class="card-actions justify-end">
                        <Link to='/warehouse' class="btn btn-primary btn-sm">Details</Link>
                        </div>
                    </div>
                </div>
                <div class="card card-compact w-96 bg-base-100 shadow-xl border">
